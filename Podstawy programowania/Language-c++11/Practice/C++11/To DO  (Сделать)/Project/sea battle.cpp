...
{  int f=1,k;
    ...
    if (code == 224)
	{
		...
		{
		case 80: {f=f*(-1);
			         if (f==1){GotoXY(30,12);SetColor(15,0);printf ("[");SetColor(0,2); printf (Rus("����� ����"));SetColor(15,0);printf ("]");
					           GotoXY(32,13);SetColor(15,0); printf (Rus("[�����]"));}
					 else{ GotoXY(30,12);SetColor(15,0);printf ("["); printf (Rus("����� ����"));printf ("]");
...
int comp(int mypole[10][10], int udar , int ud[2], int hod[1])
{
	...
	srand(time(NULL));GotoXY(24,14); SetColor(15,0);printf (Rus("  ����� ���� "));
	do {f=1;per=0; k=0;GotoXY(28,16);SetColor(15,0);printf (Rus("      "));Sleep(1000);
		...
		h=0; if (hod[0]==5){
		             for (n=ud[0]-1;n<=ud[0]+1&&n<10;n++)
					   ...
					   switch(pri){
						   case 1:
					   {if(mypole[ud[0]-1][ud[1]]==0&&ud[0]!=0){mypole[ud[0]-1][ud[1]]=3;GotoXY(28,16);SetColor(15,0);Sleep(1000);printf (Rus("����!"));prj=1;per=1;f=1;}
					   if(mypole[ud[0]-1][ud[1]]==1&&ud[0]!=0) {mypole[ud[0]-1][ud[1]]=4;GotoXY(28,16);SetColor(15,0);printf (Rus("�����!"));udar++;Sleep(1000); printf ("\x07");f=0;prj=1;per=1;hod[0]=1;}
					    break;}
						   case 2:
							    {if(mypole[ud[0]+1][ud[1]]==0&&ud[0]!=9){mypole[ud[0]+1][ud[1]]=3;GotoXY(28,16);SetColor(15,0);Sleep(1000);printf (Rus("����!"));prj=1;per=1;f=1;}
						if(mypole[ud[0]+1][ud[1]]==1&&ud[0]!=9) {mypole[ud[0]+1][ud[1]]=4;GotoXY(28,16);SetColor(15,0);printf (Rus("�����!"));udar++;Sleep(1000); printf ("\x07");f=0;prj=1;per=1;hod[0]=1;}
					    break;}
						   case 3: {if(mypole[ud[0]][ud[1]-1]==0&&ud[1]!=0){mypole[ud[0]][ud[1]-1]=3;GotoXY(28,16);SetColor(15,0);Sleep(1000);printf (Rus("����!"));prj=1;per=1;f=1;}
						if(mypole[ud[0]][ud[1]-1]==1&&ud[1]!=0) {mypole[ud[0]][ud[1]-1]=4;GotoXY(28,16);SetColor(15,0);printf (Rus("�����!"));udar++;Sleep(1000); printf ("\x07");f=0;prj=1;per=1;hod[0]=1;}
					    break;}
						   case 4:  {if(mypole[ud[0]][ud[1]+1]==0&&ud[1]!=9){mypole[ud[0]][ud[1]+1]=3;GotoXY(28,16);SetColor(15,0);Sleep(1000);printf (Rus("����!"));prj=1;per=1;f=1;}
						if(mypole[ud[0]][ud[1]+1]==1&&ud[1]!=9) {mypole[ud[0]][ud[1]+1]=4;GotoXY(28,16);SetColor(15,0);printf (Rus("�����!"));udar++;Sleep(1000); printf ("\x07");f=0;prj=1;per=1;hod[0]=1;}
					    break;}
					            }
					   }while (prj==0);
					   }}
            ...
            if (hod[0]==1)
			{
				for (i=0;i<10;i++)
					for (j=0;j<10;j++)
					{
						...
						{
							mypole[i][j]=5;
							if(i>0){if(mypole[i-1][j]==1){h=1;mypole[i-1][j]=5;GotoXY(28,16);SetColor(15,0);printf (Rus("�����!"));Sleep(1000); printf ("\x07");
							           for (i=0,x=41;i<10,x<61;i++,x=x+2)
		for (j=0,y=1;j<10,y<21;j++,y=y+2)

		  {
			  ...
			  GotoXY(x,y+1);switch(mypole[i][j]){
				  ...
				  case 5:SetColor(0,7);printf ("  ");break;}
							...
							if(i<9){if(mypole[i+1][j]==1){h=1;mypole[i+1][j]=5;GotoXY(28,16);SetColor(15,0);printf (Rus("�����!"));Sleep(1000); printf ("\x07");
							for (i=0,x=41;i<10,x<61;i++,x=x+2)
		for (j=0,y=1;j<10,y<21;j++,y=y+2)

		  {
			  ...
			  GotoXY(x,y+1);switch(mypole[i][j]){
				  ...
				  case 5:SetColor(0,7);printf ("  ");break;}
							...
							if(j>0){if(mypole[i][j-1]==1){h=1;mypole[i][j-1]=5;GotoXY(28,16);SetColor(15,0);printf (Rus("�����!"));Sleep(1000); printf ("\x07");
							for (i=0,x=41;i<10,x<61;i++,x=x+2)
		for (j=0,y=1;j<10,y<21;j++,y=y+2)

		  {
			  ...
			  GotoXY(x,y+1);switch(mypole[i][j]){
				  ...
				  case 5:SetColor(0,7);printf ("  ");break;}
							...
							if(j<9){if(mypole[i][j+1]==1){h=1;mypole[i][j+1]=5;GotoXY(28,16);SetColor(15,0);printf (Rus("�����!"));Sleep(1000); printf ("\x07");
							for (i=0,x=41;i<10,x<61;i++,x=x+2)
		for (j=0,y=1;j<10,y<21;j++,y=y+2)
      ...
      if (per==0)
	  {
		  ...
		  if (mypole[i][j]==1){mypole[i][j]=4;ud[0]=i;ud[1]=j;GotoXY(28,16);SetColor(15,0);printf (Rus("�����!"));hod[0]=5;Sleep(1000); printf ("\x07");f=0;}

		  if(mypole[i][j]==0) {mypole[i][j]=3;f=1;GotoXY(28,16);SetColor(15,0);printf (Rus("����!"));Sleep(1000);}
 ...
 for (i=0,x=1;i<10,x<21;i++,x=x+2)
		 for (j=0,y=1;j<10,y<21;j++,y=y+2)

		  {
			 ...
			 do { f=0; pop=0; GotoXY(24,14); SetColor(15,0);printf (Rus("  ����� ����� "));
			 int code =getch();
       if (code == 224)
        {GotoXY(27,16);SetColor(0,0);printf (Rus("        "));
        code = getch();
			 ...
			 case 80:
				 ...
				 case 13:{
					  ...
					  i=e/2;
				        j=y/2;
						if (pole[i][j]==0)
						{pole[i][j]=3;f=1;GotoXY(28,16);SetColor(15,0);printf (Rus("����!"));}
						else {pole[i][j]=2; printf ("\x07");GotoXY(27,16);SetColor(15,0);printf (Rus("�����!"));pop=1;udar++;}}
					   break;
						 }
				 case 27: { f=1;
    ...
    if (code == 224)
	{
		...
		{
		case 75: {f=f*(-1);
			         if (f==1){GotoXY(24,16);SetColor(15,0);printf ("[");SetColor(0,2); printf (Rus("��"));SetColor(15,0);printf ("]  ");
	                           GotoXY(31,16);SetColor(15,0);printf ("  ["); printf (Rus("���"));SetColor(15,0);printf ("]");}
					 else{ GotoXY(24,16);SetColor(15,0);printf ("["); printf (Rus("��"));printf ("]  ");
...
int main()
{
   ...
   {SetColor(0,0);
    ...
    if (code == 224)
	{
		...
		{
		case 75: {f=f*(-1);
			         if (f==1){GotoXY(23,13);SetColor(15,0);printf ("[");SetColor(0,2); printf (Rus("�������������"));SetColor(15,0);printf ("]");
	                           GotoXY(43,13);SetColor(15,0);printf ("["); printf (Rus("�������"));SetColor(15,0);printf ("]");}
					 else{ GotoXY(23,13);SetColor(15,0);printf ("["); printf (Rus("�������������"));printf ("]");
...
if (f==1){sheeps(mypole);}
   ...
   GotoXY(25,8);SetColor(15,0);printf (Rus("�������-enter"));
   GotoXY(22,9);SetColor(15,0);printf (Rus("����������-�������"));
   GotoXY(26,10);SetColor(15,0);printf (Rus("�����-Esc"));
   ...
   ud[0]=-3;ud[1]=-3;
	...
	printf(Rus("�� ���������"));fflush(stdin);getch();fflush(stdin);}
		if(chislomy==20)
		{GotoXY(33,14);SetColor(0,12);
	printf(Rus("�� ��������!"));fflush(stdin);getch();fflush(stdin);}
